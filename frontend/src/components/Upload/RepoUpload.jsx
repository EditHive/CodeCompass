...
const STYLES = `
  ...
  .pu-orb1 { width: 500px; height: 500px; background: rgba(249,115,22,0.12); top: -120px; left: -100px; animation-duration: 18s; }
  .pu-orb2 { width: 350px; height: 350px; background: rgba(20,184,166,0.09); bottom: -80px; right: -60px; animation-duration: 22s; animation-direction: reverse; }
  ...
  .pu-card {
    ...
    width: 480px;
    background: linear-gradient(160deg, rgba(16,20,16,0.95) 0%, rgba(11,14,12,0.98) 100%);
  ...
  .pu-card::before {
    ...
    background: linear-gradient(90deg, transparent, var(--accent), rgba(20,184,166,0.8), var(--accent), transparent);
    border-radius: 1px;
  ...
  .pu-input:focus {
    ...
    box-shadow: 0 0 0 3px rgba(249,115,22,0.08), 0 0 20px rgba(249,115,22,0.05);
  }
  .pu-input:focus + .pu-input-icon { color: var(--accent); }
  .pu-input.valid { border-color: rgba(20,184,166,0.4); }
  .pu-input.valid:focus { box-shadow: 0 0 0 3px rgba(20,184,166,0.06); }
  ...
  .pu-btn {
    ...
    background: linear-gradient(135deg, #f97316 0%, #ea580c 52%, #14b8a6 100%);
